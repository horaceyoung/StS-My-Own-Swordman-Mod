...
@SpireInitializer
public class MyOwnSwordmanMod implements
        EditCardsSubscriber,
    ...
    private static final String resourcesFolder = "myOwnSwordmanMod";
    ...
    public static void initialize() {
        new MyOwnSwordmanMod();

        BaseMod.addColor(ThiefSaint.Enums.CARD_COLOR, cardColor, 
                BG_ATTACK, BG_SKILL, BG_POWER, ENERGY_ORB, 
                BG_ATTACK_P, BG_SKILL_P, BG_POWER_P, ENERGY_ORB_P,
                SMALL_ORB);
    }

    public MyOwnSwordmanMod() {
    ...
    private static void loadModInfo() {
        Optional<ModInfo> infos = Arrays.stream(Loader.MODINFOS).filter((modInfo)->{
            ...
            return initializers.contains(MyOwnSwordmanMod.class.getName());
        }).findFirst();
        if (infos.isPresent()) {
            info = infos.get();
            modID = info.ID;
    ...
    public void receiveEditCharacters() {
        BaseMod.addCharacter(new ThiefSaint(),
                CHAR_SELECT_BUTTON, CHAR_SELECT_PORTRAIT, ThiefSaint.Enums.YOUR_CHARACTER);
    }
