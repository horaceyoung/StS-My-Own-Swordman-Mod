...
import static basicmod.MyOwnSwordmanMod.characterPath;

public class ThiefSaint extends CustomPlayer {
    //Stats
    ...
    //Strings
    private static final String ID = makeID("ThiefSaint"); //This should match whatever you have in the CharacterStrings.json file
