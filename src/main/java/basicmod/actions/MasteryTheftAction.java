...
public class MasteryTheftAction extends AbstractGameAction {
    private DamageInfo info;

    public MasteryTheftAction(AbstractCreature target, DamageInfo info) {
    ...
    public void update() {
        ...
        if (this.isDone) {
            ...
            if (this.target.lastDamageTaken > 0) {
                addToTop((AbstractGameAction) new GainGoldAction(this.target.lastDamageTaken));
